	...
	return (
		<section className='w-full h-full'>
			...
			<section className='flex flex-row gap-6 w-full justify-start items-start m-8'>
				<div className='bg-white py-6 px-9 shadow-[0px_4px_4px_rgba(0,0,0,0.25)] w-[362px] h-auto gap-[30px] flex flex-col'>
			...
			<section className='m-8 border-[3px] border-[#BB0000] border-solid bg-[#A3000033] h-auto max-w-[661px] w-full py-6 px-9'>
