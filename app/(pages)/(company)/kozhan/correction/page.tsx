			...
			<section className='m-4 max-w-[420px] max-[572px]:mx-auto max-[572px]:px-4'>
				...
				<div className='py-2 bg-white px-3 flex flex-col gap-2'>
					<div className='flex flex-wrap gap-2 justify-between'>
						...
						<p className='max-[670px]:text-[12px]'>+0,0016</p>
					</div>
					<div className='flex flex-wrap gap-2 justify-between'>
						<h2 className='font-bold'>RVS - 6:</h2>
						<p className='max-[670px]:text-[12px]'>Коэффициент коррекции ИИ:</p>
						<p className='max-[670px]:text-[12px]'>+0,0005</p>
					</div>
					<div className='flex flex-wrap gap-2 justify-between'>
						<h2 className='font-bold'>RVS - 7:</h2>
						<p className='max-[670px]:text-[12px]'>Коэффициент коррекции ИИ:</p>
						<p className='max-[670px]:text-[12px]'>+0,0001</p>
					</div>
					<div className='flex flex-wrap gap-2 justify-between'>
				...
				<div className='py-2 bg-white px-3 flex flex-col gap-2'>
					<div className='flex flex-wrap gap-2 justify-between'>
						...
						<p className='max-[670px]:text-[12px]'>Коэффициент коррекции ИИ:</p>
						<p className='max-[670px]:text-[12px]'>-0,0017</p>
					</div>
					<div className='flex flex-wrap gap-2 justify-between'>
						<h2 className='font-bold'>RVS - 2:</h2>
						<p className='max-[670px]:text-[12px]'>Коэффициент коррекции ИИ:</p>
						<p className='max-[670px]:text-[12px]'>-0,0019</p>
					</div>
					<div className='flex flex-wrap gap-2 justify-between'>
